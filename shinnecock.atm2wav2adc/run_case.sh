...
#SBATCH --job-name=sh_atm2wav2ocn
#SBATCH -q batch
...
#SBATCH --output=sh_atm2wav2ocn.out.log
#SBATCH --error=sh_atm2wav2ocn.err.log
#
# ----------------------------------------------------------- 
#
# ----------------------------------------------------------- 
...
${EXECnsem}/adcprep --np 5 --partmesh >  adcprep.log
${EXECnsem}/adcprep --np 5 --prepall  >> adcprep.log
